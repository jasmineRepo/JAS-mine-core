...
class MaxTraceFunctionTest {
    ...
    void testApplyFunction() {
        ...
        MaxTraceFunction.Double resultDouble = new MaxTraceFunction.Double(doubleSource, null);
    ...
    void testIntegerApplyFunction() {
        ...
        MaxTraceFunction.Integer integer = new MaxTraceFunction.Integer(intSource, null);
    ...
    void testLongApplyFunction() {
        ...
        MaxTraceFunction.Long resultLong = new MaxTraceFunction.Long(longSource, null);
    ...
    void testDoubleConstructor3() {
        MaxTraceFunction.Double actualResultDouble = new MaxTraceFunction.Double(mock(DoubleSource.class), null);
    ...
    void testIntegerConstructor3() {
        MaxTraceFunction.Integer actualInteger = new MaxTraceFunction.Integer(mock(IntSource.class), null);
    ...
    void testIntegerConstructor4() {
        ...
        MaxTraceFunction.Integer actualInteger = new MaxTraceFunction.Integer(integer, null);
    ...
    void testLongConstructor3() {
        MaxTraceFunction.Long actualResultLong = new MaxTraceFunction.Long(mock(LongSource.class), null);
    ...
    void testLongConstructor4() {
        ...
        MaxTraceFunction.Long actualResultLong = new MaxTraceFunction.Long(resultLong, null);
