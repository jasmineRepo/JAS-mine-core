...
class AlignmentUtilsTest {
    ...
    @Test
    @DisplayName("Generic predicate")
    void testExtractAgentList() {
    ...
    @Test
    @DisplayName("Filter is null")
    void testExtractAgentList2() {
    ...
    @Test
    @DisplayName("Mock filter, always returns true")
    void testExtractAgentList3() {
    ...
    @Test
    @DisplayName("Mock filter, always returns false")
    void testExtractAgentList4() {
        Predicate<Object> predicate = mock(Predicate.class);
