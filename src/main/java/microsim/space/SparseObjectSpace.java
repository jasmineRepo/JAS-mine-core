...
public class SparseObjectSpace extends AbstractSpace<Object> implements ObjectSpace {
    ...
    public boolean add(Object o) {
        if (!(o instanceof SpacePosition))
            // throw new ClassCastException("Method add() accepts only GridPositionInterface
            // objects.");
            return false;
    ...
    /**
     * Add an object implementing IGridPosition interface to the grid.
     * If the destination cell is already occupied the method return false and the
     * object
     * is not added.
     * 
     * @param object The IGridPosition object to be added.
     * @return True if object has been added. False if destination cell is already
     *         occupied or
     ...
     * @return true if object has been removed. False if object is null or is not
     *         present on
     *         the grid.
     */
