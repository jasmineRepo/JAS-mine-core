...
public class MultiKeyCoefficientMapFactory {
    ...
    public static MultiKeyCoefficientMap createMapFromAnnotatedList(List<?> list)
            ...
            for (String value : values) {
                switch (keys.length) {
                    case 1:
                        ...
                        break;
                    case 2:
                        map.putValue(getValue(clazz, keys[0], object), getValue(clazz, keys[1], object), value,
                                getValue(clazz, value, object));
                        break;
                    case 3:
                        map.putValue(getValue(clazz, keys[0], object), getValue(clazz, keys[1], object),
    ...
    private static Object getValue(Class<?> clazz, String fieldName, Object object)
