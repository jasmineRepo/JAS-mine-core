...
public class ExperimentManager {
    ...
    /**
     * The flag determines whether the input folder should remain constant for
     * multiruns
     */
    ...
    // if (newFile.getPath().startsWith(folder.getPath() + File.separator +
    // "database")) {
    ...
    //
    // FileOutputStream fos = new FileOutputStream(newFile.getParent() +
    // File.separator + "database." + newFile.getName());
    //
    // int len;
    ...
    public Experiment setupExperiment(Experiment experiment, Object... models) throws Exception {
        ...
        if (copyInputFolderStructure) {
            ...
            // File inputDBFile = new File(experiment.inputFolder + File.separator +
            // inputDatabaseName);
