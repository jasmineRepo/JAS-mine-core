...
public class DatabaseUtils {
    ...
    public static Experiment createExperiment(EntityManager entityManager, Experiment experiment, Object... models)
    ...
    public static void snap(EntityManager em, Long run, Double time, Object target)
        ...
        // final Field idField = target.getClass().getDeclaredField("id"); //Relies on
        // the name of the field being 'id', which may not be true if the user gives it
        // another name.
        // if (idField != null)
        ...
        if (idField != null)
            ...
            throw new IllegalArgumentException("Object of type "
                    + target.getClass()
                    + " cannot be exported to database as it does not have a field of type PanelEntityKey.class or it is null!");
