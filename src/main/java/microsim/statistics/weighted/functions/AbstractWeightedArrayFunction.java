...
/**
 * This class represents the skeleton for all the function which operate on
 * array of native data type values,
 * appropriately weighted by weights specified in a corresponding array of
 * doubles.
 * Each inheriting class automatically implements the <i>IUpdatableSource</i>
 * and the <i>ISimEventListener</i>,
...
public abstract class AbstractWeightedArrayFunction extends AbstractFunction {
    ...
    /**
     * Force the function to update itself. If the data source implements the
     * <i>IUpdatableSource</i>
     ...
     * @throws UnsupportedOperationException If the function is not able to work on
     *                                       double data type.
     */
