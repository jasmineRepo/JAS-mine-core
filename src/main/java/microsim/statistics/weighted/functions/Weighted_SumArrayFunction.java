...
/**
 * This class computes the sum of an array of source values, with each element
 * of the array
 * multiplied by the weight of the source (the source must implement the
 * <i>Weight</i>
 * interface). According to the source data type there are four data-type
