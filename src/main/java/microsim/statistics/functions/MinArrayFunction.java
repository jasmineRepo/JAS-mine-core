...
/**
 * This class computes the minimum value in an array of source values. According
 * to the source data type
 * there are four data-type oriented implementations. Each of them implements
 * always the
...
public abstract class MinArrayFunction extends AbstractArrayFunction implements IDoubleSource {
     ...
     */
    public MinArrayFunction(IFloatArraySource source) {
        super(source);
    }
     ...
     * @param source The data source.
     */
    public MinArrayFunction(IIntArraySource source) {
        super(source);
    }
     ...
     * @param source The data source.
     */
    public MinArrayFunction(ILongArraySource source) {
        super(source);
    }
     ...
     * @param source The data source.
     */
    public MinArrayFunction(IDoubleArraySource source) {
        super(source);
    }
