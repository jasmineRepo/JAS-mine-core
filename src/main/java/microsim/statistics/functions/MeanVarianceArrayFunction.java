...
/**
 * This class computes the average and variance value of an array of values
 ...
 * In order to retrieve the mean pass the MeanVarianceFunction.MEAN argument to
 * the getDoubleValue function,
...
public class MeanVarianceArrayFunction extends AbstractArrayFunction implements IDoubleSource {
    ...
    private void setValues(int count, double sum, double sumOfSquares) {
        if (count == 0) {
            ...
            variance = (sumOfSquares - mean * sum) / (double) count; // This is a population variance as it is the
                                                                     // variance of the array's data.
        }
        ...
        switch ((MeanVarianceArrayFunction.Variables) variableID) {
            ...
            default:
                throw new UnsupportedOperationException(
                        "The function result with id " + variableID + " is not supported.");
        }
    }
