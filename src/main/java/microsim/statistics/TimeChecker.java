 ...
 * <i>IUpdatableSource</i> interface to
 * avoid repetitive updates.<br>
 * Every time the <i>updateSource</i> method of the user class is invoked, it
 * asks to TimeChecker
 * if the update has been done yet at the current simulation time.<br>
 * If the time checker is disabled it force the users to always update
 * themselves.
 * 
 * <p>
 * Title: JAS
 ...
 * @deprecated use {@link microsim.caching.OnceUntil#timeChanges} instead
 */
...
public class TimeChecker {
     ...
     * 
     * @return True if the method has not yet been invoked at the current time,
     *         false otherwise
     */
